...
登録日: 2026-09-21。対象は `zabaglione/jr200-web-emulator`（private）。以下はGitHubから返された実際のIssue番号。2026-09-22までにP00〜P09を順に受け入れた。
...
#1〜#10は順に受入完了。次は#11のCJR信号生成・WAVエンコードである。未合格の依存を無言で飛ばさない。Web Audioと、カセットWAV変換・実機WAV往復の合格は別である。
