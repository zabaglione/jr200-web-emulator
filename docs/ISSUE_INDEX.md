...
登録日: 2026-09-21。対象は `zabaglione/jr200-web-emulator`（private）。以下はGitHubから返された実際のIssue番号。2026-09-22までにP00〜P04を順に受け入れ、P05以降は未着手である。
...
#1〜#5は順に受入完了。次は#6のMN1271・MN1544・CRTCとシステム時刻へ進む。未合格の依存を無言で飛ばさない。CPU単体の合格とエミュレータの完成は別である。
