...
登録日: 2026-09-21。対象は `zabaglione/jr200-web-emulator`（private）。以下はGitHubから返された実際のIssue番号。2026-09-22までにP00〜P07を順に受け入れた。
...
#1〜#8は順に受入完了。次は#9のCJRカセットLOAD/MLOAD/SAVE/MSAVE統合へ進む。未合格の依存を無言で飛ばさない。メモリ注入やデバッガ観測と、通常カセット・音声・実機WAV往復の合格は別である。
