...
| 配布範囲 | private初版はソースとローカルビルド手順。2026-09-23の追補で、ROM等を同梱しないGitHub Pages配信を別途対象にした |
...
この「一般公開サイト」の除外はprivate初版0.0.1の範囲を記録したもので、後続の[Pages配信](PAGES_DEPLOYMENT.md)を禁止するものではない。
