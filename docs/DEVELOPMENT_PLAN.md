...
| P09 | [音声のWeb出力・休止復帰](issues/P09.md) | P08 | 2026-09-22ローカル受入完了。明示開始Web Audio、sample rate、mute、休止復帰を確認。 |
...
P00〜P08は受入完了。P09はローカル受入後のremote CI待ちで、次の依存工程はP10のCJR信号生成・WAVエンコードである。スクリプトによる自動closeはしない。実機試験に進めない場合も、未検証を隠して依存工程を完了扱いにしない。
