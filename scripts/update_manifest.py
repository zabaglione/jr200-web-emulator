...
top_files=['README.md','LICENSE','THIRD_PARTY_NOTICES.md','SBOM.spdx.json','requirements-ci.txt','AGENTS.md','CMakeLists.txt','Makefile','.gitignore','.gitattributes','.editorconfig','.emscripten-version','source-manifest.json']
